...
namespace BulkyBook.Areas.Admin.Controllers
{
    ...
    public class CategoryController : Controller
    {
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            if(objFromDb == null)
            {
                TempData["Error"] = "Error while deleting selected category";
            ...
            // TempData["Success"] = ("Category {0} sucessfully deleted", objFromDb.Name);
            TempData["Success"] = "Category : " + objFromDb.Name +  " sucessfully deleted";
